...
class NextMealsTest(TestCase):
    def test_get_next_meals_returns_undone_meals_in_order(self):
        ...
        self.assertEquals("test2", meals[0].meal_owner.name)
        self.assertEquals("description test2", meals[0].description)
        self.assertEquals(meal2.id, meals[0].id)
        self.assertEquals("test4", meals[1].meal_owner.name)
        self.assertEquals("description test4", meals[1].description)
        self.assertEquals(meal3.id, meals[1].id)
        self.assertEquals("test3", meals[2].meal_owner.name)
        self.assertEquals("description test3", meals[2].description)
        self.assertEquals(meal4.id, meals[2].id)
